...
export default function Index() {
    return (
        <section className="pt-20 sm:pt-24 md:pt-30 mx-auto w-full min-h-screen font-raleway flex flex-col items-center justify-start">
            ...
            <div className="relative w-full bg-ebony-500 mt-10 sm:mt-15">
                <svg
                    viewBox="0 0 1200 180"
                    preserveAspectRatio="none"
                    className="absolute top-0 left-0 w-full h-[50px] sm:h-[65px] md:h-[80px] -translate-y-full z-10 text-ebony-500"
                >
