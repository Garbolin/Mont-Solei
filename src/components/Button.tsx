...
export default function Button({
    ...
    const colorClasses: Record<ColorKey, { filled: string; outline: string }> = {
        terracotta: {
            ...
            outline:
                'bg-transparent text-terracotta-500 border border-terracotta-500 hover:bg-terracotta-500 hover:text-porcelain-500',
        },
        olive: {
            filled: 'bg-olive-500 text-porcelain-500 hover:bg-transparent hover:text-olive-500 border-olive-500',
            outline:
                'bg-transparent text-olive-500 border border-olive-500 hover:bg-olive-500 hover:text-porcelain-500',
        },
        paleoak: {
            filled: 'bg-paleoak-500 text-porcelain-500 hover:bg-transparent hover:text-paleoak-500 border-paleoak-500',
            outline:
                'bg-transparent text-paleoak-500 border border-paleoak-500 hover:bg-paleoak-500 hover:text-porcelain-500',
        },
        graphite: {
            filled: 'bg-graphite-500 text-porcelain-500 hover:bg-transparent hover:text-graphite-500 border-graphite-500',
            outline:
                'bg-transparent text-graphite-500 border border-graphite-500 hover:bg-graphite-500 hover:text-porcelain-500',
        },
        porcelain: {
            filled: 'bg-porcelain-500 text-transparent hover:bg-transparent hover:text-porcelain-500 border-porcelain-500',
            outline:
                'bg-transparent text-porcelain-500 border border-porcelain-500 hover:bg-porcelain-500 hover:text-graphite-500',
        },
    };
